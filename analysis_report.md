...
LinearRegression:  R² трейн = 0.5923, R² тест = 0.5941
Lasso (alpha=1.0): R² трейн = 0.5923, R² тест = 0.5941
Lasso (best alpha): R² трейн = 0.5682, R² тест = 0.5940
ElasticNet (best): R² трейн = 0.5761,  R² тест = 0.5722
